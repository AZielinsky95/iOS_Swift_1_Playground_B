...
//It works because we declared the variable as being optional meaning it may be nil
 ...
 */
var stringWithNum :String = "23"
var convertedString = Double(stringWithNum)
//It gets converted to an optional Double

/*:
 - Experiment:
 With your newly converted `Double` from a `String`, try multiplying it with the 'ratio' variable. What happens?
 */
ratio * convertedString! // it needs to be unwrapped
...
string = optionalString! // FORCE UNWRAP IT
 ...
 */
//"gravityConstant did not unwrap"
 ...
 */
var anotherArray = ["Hi","Hello","Bye"]

anotherArray.first

if let firstItem = anotherArray.first
{
    print(firstItem)
}
else
{
print("firstItem did not unwrap")
}
/*:
 - Experiment:
 ...
 */
if let index = anotherArray.index(of: "Hi")
{
    print(index)
}
else
{
    print("index did not unwrap")
}
...
*/
//: [Next](@next)
var myDict = ["Mazda3" : 50000, "CRV" : 60000, "Hummer" : 100000]

if let mazdaPrice = myDict["Mazda3"]
{
    print("Mazda3 costs \(mazdaPrice)")
}
if let crvPrice = myDict["CRV"]
{
    print("CRV costs \(crvPrice)")
}
if let hummerPrice = myDict["Hummer"]
{
    print("Hummer costs \(hummerPrice)")
}
if let bmwPrice = myDict["BMW"]
{
    print("BMW costs \(bmwPrice)")
}
else
{
     print("BMW did not unwrap")
}
