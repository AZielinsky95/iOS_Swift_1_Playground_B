 ...
 */
var shape2 = NamedShapeClass(name: "Square", numOfSides: 4)
shape2.description()
...
class Square : NamedShapeClass {
    ...
    override func description() -> String {
        return "Shapes length of side : \(length) with : \(numberOfSides) sides."
    }
    
}

var square = Square(sideLength: 4, name: "square")
square.description()
